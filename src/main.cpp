...
// Declare the custom font generated by lv_font_conv.py
LV_FONT_DECLARE(font_custom_merged);
...
void setup()
{
    ...
    lv_obj_set_style_text_font(lb_test, &font_custom_merged, LV_PART_MAIN);
